namespace advent_of_code_2021.Solvers.Day04.PuzzleB
{
    public class Solver
    {
        ...
        )
        {
            ...
            {
                var bingoBoardsToRemove = new List<List<List<BingoCell>>>();
                ...
                bingoBoards.RemoveAll(bb => bingoBoardsToRemove.Contains(bb));
            }
